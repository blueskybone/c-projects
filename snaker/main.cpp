...
int main()
{
	...
	else
	{
		...
		{
			case 1: break;
			case 2:Des(); goto back2; break;
			case 3:Infor();goto back2; break;
			case 4: exit(0); break;
			default:goto back1; break;
		}
		//初始化
		cleardevice();			
		CreatMap();
...
void Infor()
{
	...
	putimage(0, 0, &ima);
	char infor[5][200]={"程序使用的背景图片来源于p站画师，ID:2033916，其他素材来源于网络","本程序使用图形库EasyX开发，下载官网：easyx.cn","VS报错：outtextxy未定义标识符。解决：项目->project属性->高级->字符集改为使用多字节字符集","2020.9.23",};
